# Project aims to read the live video feed from the camera, and overlay the products onto detected faces&bodies, simulating a VIRTUAL TRAIL ROOM experience.


import cv2
goggles_img = cv2.imread('./mask2.png', -1)  # -1 to load with alpha

# Initialize the webcam
cap = cv2.VideoCapture(0)

# Using haarcascade_frontalface_default.xml for face detection.
# Load the Haar Cascade classifier face detection
